...
name="new_type" value="<?php echo $type_title; ?>"></td>
...
<tr>
<td></td>
<td align="right"><input id="btn" type="submit"

name="update_type" value="Update type"></td>
...
$update_type = "update types set type_title='$new_type'

where type_id='$update_id'";

$run_type = mysqli_query($con, $update_type);
if ($run_type) {
echo "<script>alert('type has been UPDATED

successfully!')</script>";
echo

"<script>window.open('index.php?view_types','_self')</script>";
