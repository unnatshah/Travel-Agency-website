...
emp_name='$employee_name', emp_email='$employee_email',
emp_designation='$employee_designation',
emp_location='$employee_location', emp_address='$employee_address',
emp_contact='$employee_contact' where emp_id='$update_id'";
$run_pack = mysqli_query($con, $update_employee);
if ($run_pack) {
echo "<script>alert('An employee has been UPDATED
successfully!')</script>";
echo
"<script>window.open('index.php?view_employees','_self')</script>";
}
}
?>
<!DOCTYPE html>
...
<tr align="center">
<td colspan="7"><h2 style="font-family:

Cambria;margin-top: 20px; margin-bottom: 15px;">Insert New
Employee</h2>
...
value="<?php echo $emp_name; ?>" size="40"></td>
...
value="<?php echo $emp_email; ?>" size="40"></td>

</tr>
<tr>
<td align="right"><b>Employee

Designation:</b></td>

<td><input type="text" name="emp_designation"

value="<?php echo $emp_designation; ?>"></td>

</tr>
<tr>
<td align="right"><b>Employee Location:</b></td>
<td><input type="text" name="emp_location"

value="<?php echo $emp_location; ?>"></td>

</tr>
<tr>
<td align="right"><b>Employee Address:</b></td>
<td><textarea name="emp_address" cols="40"

rows="10"><?php echo $emp_address; ?></textarea></td>

</tr>
<tr>
<td align="right"><b>Employee Contact:</b></td>
<td><input type="text" name="emp_contact"
value="<?php echo $emp_contact; ?>" size="30"></textarea>
