...
<tr align="center">
<td colspan="6"><h2 style="font-family: Cambria;

margin-top: 10px; margin-bottom: 5px;">View All
packages
Here</h2></td>
</tr>
...
$pack_image; ?>" width="40" height="40"></td>

<td><?php echo $pack_price; ?></td>
<td><a href="index.php?edit_pack=<?php echo

$pack_id; ?>">Edit</a></td>

<td><a href="delete_pack.php?delete_pack=<?php

echo $pack_id; ?>">Delete</a></td>
<td></td>
</tr>
<?php
}
