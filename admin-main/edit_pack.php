...
<tr align="center">
<td colspan="7"><h2 style="font-family: Cambria;

margin-top: 20px; margin-bottom: 15px;">Edit & Update
Package</h2>
...
<td><input type="text" name="package_title" size="60"

value="<?php echo $pack_title; ?>"></td>
...
$category_id; ?>"><?php echo $category_title; ?></option>

<?php $get_cats = "select * from categories";
$run_cats = mysqli_query($con, $get_cats);
while ($row_cats =

mysqli_fetch_array($run_cats)) {

$cat_id = $row_cats['cat_id'];
$cat_title = $row_cats['cat_title'];
echo "<option value='$cat_id'>$cat_id -
...
<td><input type="file" name="package_image"><img
src="package_images/<?php echo $pack_image; ?>"
width="50" height="50"></td>

</tr>
<tr>
<td align="right"><b>Package Price:</b></td>
<td><input type="text" name="package_price"

value="<?php echo $pack_price; ?>"></td>
...
rows="10"><?php echo $pack_desc; ?></textarea></td>

</tr>
<tr>
<td align="right"><b>Package Keywords:</b></td>
<td><input type="text" name="package_keywords"
size="70" value="<?php echo $pack_keywords; ?>"></td>

</tr>
<tr align="center">
<td colspan="7"><input style="margin-top: 10px;

margin-bottom: 15px;" type="submit"

name="update_package"

value="Update Package"></td>
...
$update_package = "update packages set
package_cat='$package_cat', package_type='$package_type',
package_title='$package_title', package_price='$package_price',
package_desc='$package_desc', package_keywords='$package_keywords'
where package_id='$update_id'";
} else {
move_uploaded_file($package_image_tmp,
"package_images/$package_image");
$update_package = "update packages set
package_cat='$package_cat', package_type='$package_type',
package_title='$package_title', package_price='$package_price',
package_desc='$package_desc', package_image='$package_image',
package_keywords='$package_keywords' where package_id='$update_id'";
}
$run_pack = mysqli_query($con, $update_package);
if ($run_pack) {
echo "<script>alert('Package has been UPDATED
successfully!')</script>";
echo
"<script>window.open('index.php?view_packages','_self')</script>";
}}?>