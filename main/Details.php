...
5px;line-height: 40px;">Welcome Guest! <b

style="color: yellow;">Shopping Cart-

</b> Total Items: Total Price: <a href="cart.php"
...
$get_pack = "select * from packages where
...
src='admin_area/package_images/$pack_image' width='400' height='300'>

<p><b>Cost $ $pack_price</b></p>
<p>$pack_desc</p>
<a href='index.php' style='float: left;

font-size: 18px;'>Go Back</a>

<a

href='index.php?pack_id=$pack_id'><button style='float: right;font-
size:16px; cursor: pointer; padding: 2px 4px;

margin:2px;'>Book</button></a>
</div>
";
}
}
